...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="row placeholders">
            <div class="col-xs-6 col-sm-2 placeholder">
              <button type="button" onclick="cargar('#divtest','http://localhost:8080:8080/codeIgniter/index.php/Controlador_admInicio/verFamilia')" class="btn btn-success">Ver familia</button>
            </div>
            <div class="col-xs-6 col-sm-2 placeholder">
              <button type="button" onclick="cargar('#divtest','http://localhost:8080:8080/codeIgniter/index.php/Controlador_admInicio/agregarFamilia')" class="btn btn-primary">Agregar familia</button>            
            </div>
            <div class="col-xs-6 col-sm-2 placeholder">
